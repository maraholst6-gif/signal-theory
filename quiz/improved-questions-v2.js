export const questions = [
  ...
  // Q4 - Template 6: Action-Based Reframe
  {
    ...
    options: [
      {
        label: "A) One more try with a specific low-pressure plan: 'Quick coffee Wednesday, 30 minutes, I'll even time it'",
        value: 'A',
        scoring: { signal: 'GOOD' }
      },
      {
      ...
      {
        label: "C) Go direct: 'I'm enjoying talking, but I'd rather meet in person. Let me know when you're free'",
        value: 'C',
        scoring: { signal: 'GOOD' }
      },
      {
  ...
  // Q5 - Template 1: Forced Trade-Off
  {
    id: 5,
    dimension: 'signal',
    text: "You're chatting with two women from apps. One sends long, thoughtful messages but takes a day to reply. The other replies instantly but keeps it to a few words. You only have bandwidth to pursue one. Who do you prioritize?",
    options: [
      {
      ...
      {
        label: "C) Neither tells you enough — suggest meeting both and decide in person",
        value: 'C',
        scoring: { signal: 'GOOD' }
      },
      {
        label: "D) Whichever one is more attractive — texting style doesn't predict chemistry",
        value: 'D',
        scoring: { signal: 'CAUTIOUS' }
      }
    ]
  ...
  // Q10 - Template 4: Friend Advice Flip
  {
    ...
    options: [
      {
        label: "A) 'Happy for you man, just make sure you're not running from the hard stuff'",
        value: 'A',
        scoring: { readiness: 'HIGH' }
      },
      {
  ...
  // Q13 - Template 1: Forced Trade-Off
  {
    ...
    options: [
      ...
      {
        label: "C) Keep seeing her — everything else is there, spark might come",
        value: 'C',
        scoring: { strategy: 'PASSIVE' }
      },
      {
        label: "D) Talk to her about it directly — maybe she's feeling the same way",
        value: 'D',
        scoring: { strategy: 'CALIBRATED' }
      }
    ]
  ...
  // Q14 - Template 6: Action-Based Reframe
  {
    ...
    options: [
      {
        label: "A) Match her pace — delete your apps too, signal you're focusing on her",
        value: 'A',
        scoring: { strategy: 'OVER_INVESTING' }
      },
      {
      ...
      {
        label: "C) Say nothing and see if she brings it up — maybe she's just decluttering",
        value: 'C',
        scoring: { strategy: 'PASSIVE' }
      },
      {
        label: "D) Delete your apps but keep talking to the other person you're most interested in",
        value: 'D',
        scoring: { strategy: 'ANXIOUS' }
      }
    ]
  ...
  // Q15 - Template 1: Forced Trade-Off
  {
    id: 15,
    dimension: 'strategy',
    text: "After four dates, she invites you to a party where all her close friends will be. What's your move?",
    options: [
      {
        label: "A) Say yes — meeting her friends is a natural next step",
        value: 'A',
        scoring: { strategy: 'CALIBRATED' }
      },
      {
        label: "B) Say yes, but you feel a little pressure — is this too much too soon?",
        value: 'B',
        scoring: { strategy: 'ANXIOUS' }
      },
      {
        label: "C) Suggest spending one-on-one time instead — you'd rather build more foundation first",
        value: 'C',
        scoring: { strategy: 'PASSIVE' }
      },
      {
        label: "D) Go and see it as a major milestone — she's integrating you into her life",
        value: 'D',
        scoring: { strategy: 'OVER_INVESTING' }
      }
    ]
